...
const Landingpage = () => {
  ...
  const handleSearch = useCallback(debounce(getProperties, 500), []);
      ...
      <div className="font pt-">
        ...
        <div className="  items-center md:-mt-14  ">
          <div className="md:flex justify-center grid grid-flow-row gap-y-1 py-2 opacity-100  rounded-full ">
            <div className="flex rounded-lg md:shadow-lg border-2 md:border-0">
              {" "}
              <svg
                className="h-14 w-14 pt-3 pb-3  bg-white rounded-bl-2xl rounded-tl-2xl"
              ...
              <select
                ...
                name="category"
                label="category"
                className="px-4 border-l-0   text-black capitalize  md:-ml-1 w-52"
            ...
            {showBedRoom && (
              <div className="flex rounded-lg md:rounded-none md:shadow-lg border-2 md:border-0">
                {" "}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-14 w-14  pt-3 pb-3  bg-white"
            ...
            <div className="flex md:shadow-lg border-2 md:border-0 rounded-lg md:">
              {" "}
              <svg
                className="h-14 w-14  pt-3 pb-3   bg-white"
              ...
              <div className=" p md:-ml-1">
                <input
                  ...
                  className=" px-3 md:w-96 py-1 h-14 bg-white "
              ...
              {searchText ? (
                <button>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-14 w-14 px-2 md:hidden bg-white"
            ...
            <div className="hidden md:flex">
              {searchText ? (
                <div className="flex md:shadow-lg rounded-lg">
                  <button className="rounded-br-2xl rounded-tr-2xl bg-white px-4">
                    Search Properties
                  </button>
                </div>
              ) : (
                <div className="flex md:shadow-lg rounded-2xl">
                  {" "}
                  <button className="rounded-br-2xl rounded-tr-2xl bg-white px-4">
                    Search Properties
                  </button>
