...
<div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5">
       ...
       <Link to="/request"> <button href="/request" class="inline-flex items-center px-3 py-2 text-sm grad-btn font-medium text-center text-white  rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Intrested
