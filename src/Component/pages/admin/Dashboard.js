...
const Dashborad = () => {
  ...
  <path d="M5.082 14.254a8.287 8.287 0 00-1.308 5.135 9.687 9.687 0 01-1.764-.44l-.115-.04a.563.563 0 01-.373-.487l-.01-.121a3.75 3.75 0 013.57-4.047zM20.226 19.389a8.287 8.287 0 00-1.308-5.135 3.75 3.75 0 013.57 4.047l-.01.121a.563.563 0 01-.373.486l-.115.04c-.567.2-1.156.349-1.764.441z" />
    ...
    <div className="px-6 py-4">
      <div className=" font-bold  text-rose-700  text-xl mb-2">Users</div>
      <p>All Users</p>
  ...
  <path d="M12 5.432l8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 01-.75-.75v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75V21a.75.75 0 01-.75.75H5.625a1.875 1.875 0 01-1.875-1.875v-6.198a2.29 2.29 0 00.091-.086L12 5.43z" />
    ...
    <div className="px-6 py-4">
      ...
      <Link to = "/admin/propertylist"><button  className='bg-blue-500 w-14 rounded-md text-white hover:hover:bg-teal-600'>View</button></Link>
        ...
        {/* <div className="max-w-sm rounded overflow-hidden shadow-lg text-center   bg-stone-100">
  ...
  <path d="M12 5.432l8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 01-.75-.75v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75V21a.75.75 0 01-.75.75H5.625a1.875 1.875 0 01-1.875-1.875v-6.198a2.29 2.29 0 00.091-.086L12 5.43z" />
    ...
    <div className="px-6 py-4">
      <div className="  font-bold text-xl mb-2 ">Properties</div>
      <p>All Registered Properties</p>
      {userData.map((lenght,i)=>())}
