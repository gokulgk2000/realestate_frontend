    ...
    <div>
      ...
      <div className="">
        <div className="md:pl-20 md:pr-32 py-4">
          <div className=" md:grid py-4 px-8  bg-white shadow-lg gap rounded-2xl ">
            <h3 className="pb-5 font text-lg">Property Details</h3>
            <div className="md:grid  grid-rows-4 grid-flow-col gap-7 gap-x-36 capitalize  ">
              <div className="text-sm  ">
                Seller: <span className="font  ">{property?.Seller}</span>
              </div>
              <div className="text-sm    ">
                Location:<span className="  font ">{property?.location}</span>
              </div>
              <div className="text-sm   ">
                Layoutname:
                <span className="  font ">{property?.layoutName}</span>
              </div>
              <div className="text-sm   ">
                Landarea:<span className=" font ">{property?.landArea}</span>
              </div>
              <div className="text-sm   ">
                Facing:<span className="  font ">{property?.facing}</span>
              </div>
              <div className="text-sm   ">
                Approchroad:
                <span className="  font ">{property?.approachRoad}</span>
              </div>
              <div className="text-sm   ">
                Builtarea:<span className="  font ">{property?.builtArea}</span>
              </div>
              <div className="text-sm   ">
                Bedroom:<span className="  font ">{property?.bedRoom}</span>
              </div>
              <div className="text-sm   ">
                Floordetails:
                <span className="  font "> {property?.floorDetails}</span>
              </div>
              <div className="text-sm   ">
                Status:<span className="  font ">{property?.status}</span>
              </div>
              <div className="text-sm   ">
                Neartown:<span className="  font ">{property?.nearTown}</span>
              </div>
              <div className="text-sm   ">
                Costsq:<span className="  font ">₹.{property?.costSq}sft</span>
              </div>
              <div className="text-sm  ">
                Askprice:<span className="  font ">₹.{property?.askPrice}</span>
              </div>
              <div className="text-sm  ">
                Property Type:
                <span className="  font ">{property?.category?.name}</span>
              </div>{" "}
              <div className="text-sm   ">
                Facilties:
                <span className="  text-ellipsis overflow-hidden font">
                  {property?.facilities}
...
{
  /* <div className="grid md:grid-cols-2 bg-emerald-50 md:px-10  px-5 text-sm   -serif">
        ...
        <div className="">
          <ul className="grid md:grid-cols-2 md:gap-7 capitalize text-xl leading-loose pl-1">
            ...
            <li className="   justify-start gap-2">
              <div className="text-sm   ">Layoutname:</div>
              <div>{property?.layoutName}</div>
            </li>
            <li className="   justify-start gap-2">
              <div className="text-sm   ">Landarea:</div>
            ...
            <li className="   justify-start gap-2">
              <div className="text-sm   ">Approchroad:</div>
              <div>{property?.approachRoad}</div>
            </li>
            <li className="   justify-start gap-2">
              <div className="text-sm   ">Builtarea:</div>
            ...
            <li className="   justify-start gap-2">
              <div className="text-sm   ">Floordetails:</div>
            ...
            <li className="   justify-start gap-2">
              <div className="text-sm   ">Neartown:</div>
              <div>{property?.nearTown}</div>
            </li>
            <li className="   justify-start gap-2">
              <div className="text-sm   ">Costsq:</div>
              <div>₹.{property?.costSq}sft</div>
            </li>
            <li className="   justify-start truncate gap-2">
              <div className="text-sm   ">Facilties:</div>
          ...
          <div className="   justify-around pt-">
            <button className="bg-blue-500 hover:bg-teal-700 text-white text-sm   -sans py-2 px-4 rounded ">
              Seller Contact
            </button>{" "}
          </div>
        </div>
