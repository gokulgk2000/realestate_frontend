...
const PropertyList = () => {
  ...
  const getAllProperties = async () => {
    ...
    setLoading(false);
    console.log(allProperties,":gokul")
  };
  useEffect(() => {
    getAllProperties();
  }, []);
...
const updateorderlistProperties = async (value,propertyId) =>{
  const res = await orderlist({propertyId, order:value})
  if(res.success){
    await  getAllProperties();
  }
        ...
        <>
          <Breadcrumbs>
            ...
            <Link to="/admin/PropertyList" disabled>
              <button className="text-amber-700 font">Properties List</button>
            </Link>
          </Breadcrumbs>
              ...
              <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  ...
                  <th scope="col">
                    ...
                    <p className="pb-10 px-6 md:hidden  text-amber-700">
                      seller
                    </p>
                  </th>
                  <th
                  ...
                  <th
                    scope="col"
                    className="py-3 px-6   text-amber-700  hidden md:block"
                  >
                    ...
                    >
                      ...
                      >
                        <ul className=" text-sm font-medium text-gray-900 rounded-lg  dark:text-white">
                          <li className="w-full ">
                            <div className="flex items-center pl-3">
                           { PropertyData?.isPremium === true &&  <input
                                type="number"
                                ...
                                onChange={(e)=>updateorderlistProperties(e.target.value, PropertyData?._id)}
                              />
}   
                              <label
                                for="vue-checkbox"
