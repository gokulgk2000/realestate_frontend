...
<button
      ...
      {isBiggerthanTab ? (
        <img
          className="w-full aspect-[2/1] h-96" 
      ...
      <div className="text-center">
        ...
        ))}   <div className="md:-mt-24 -mt-12"> <Search/></div>
      </div>
