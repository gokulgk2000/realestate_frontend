...
<div className="w- flex justify-around items-center mt-2 pb-4  ">
     <div>   <input
          type="text"
          placeholder="search"
          name="search"
          className="look md:w-96 px-3 py-2 bg-slate-200 rounded-tl-full rounded-bl-full border-0 focus:outline-0"
